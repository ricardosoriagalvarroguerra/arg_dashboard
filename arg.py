...
st.set_page_config(layout="wide")  # Esta línea DEBE ir primero
...
# Obtener el último registro para calcular la brecha cambiaria y la fecha
...
# Crear dos columnas de igual tamaño y casi sin separación para que estén juntos
